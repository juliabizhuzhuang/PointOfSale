namespace WindowsFormsPOS
{
    ...
    public class AutoCompleteTextboxBarcode : TextBox
    {
        #region Fields
        ...
        // the constructor
        public AutoCompleteTextboxBarcode()
            : base()
        {
        ...
        private void InitializeComponent()
        {
            this.SuspendLayout();
            // 
            // AutoCompleteTextboxBarcode
            // 
            this.TextChanged += new System.EventHandler(this.AutoCompleteTextboxBarcode_TextChanged);
            this.ResumeLayout(false);

        }

        private void AutoCompleteTextboxBarcode_TextChanged(object sender, EventArgs e)
        {
