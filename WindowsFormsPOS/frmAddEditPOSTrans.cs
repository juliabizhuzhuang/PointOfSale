...
{
    public partial class frmAddEditPOSTrans : Form
        {
            int productID;
            int categoryID;
            public frmAddEditPOSTrans(int prodID)
            {
                InitializeComponent();
                productID = prodID;
            }
            ...
            private void frmAddEditProduct_Load(object sender, EventArgs e)
            {
                ...
                {
                    lblTitle.Text = "Adding New Transaction";
                    ClearFields();
                    GetProductNo();
                }
                else
                {
                    lblTitle.Text = "Updating Transaction";
                    LoadUpdateCategory();
                }
            }
