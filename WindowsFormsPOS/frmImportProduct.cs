    ...
    public partial class frmImportProduct : Form
    {
        ...
        public void ImportProducts()
        {
            try
            {
                ...
                MessageBox.Show(importCount + " Products successfully imported. " + duplicateCount + " Duplicate product.", "Import Product", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private bool IsProductExsit(string productCode, string productName)
        {
            ...
            try
            {
                ...
                //using (MySqlConnection conn = new MySqlConnection("Server = '" + SQLConn.ServerName + "';  " + "Port = '" + SQLConn.PortName + "'; " + "Database = '" + SQLConn.DBName + "'; " + "user id = '" + SQLConn.UserName + "'; " + "password = '" + SQLConn.Pwd + "'"))
                //{
                //    conn.Open();

                //    using (SqlCommand cmd = new System.Data.SqlClient.SqlCommand(strSql, conn))
                //    {
        ...
        private int GetProductID(string productCode, string productName)
        {
            ...
            try
            {
                ...
                //using (SQLConn conn = new SQLConn("Server = '" + SQLConn.ServerName + "';  " + "Port = '" + SQLConn.PortName + "'; " + "Database = '" + SQLConn.DBName + "'; " + "user id = '" + SQLConn.UserName + "'; " + "password = '" + SQLConn.Pwd + "'"))
                //{
                //    conn.Open();

                //    using (MySqlCommand cmd = System.Data.SqlClient.SqlCommand(strSql, conn))
                //    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No Product to Import! Please select file to import.", "Import Product", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
    }
}
